...
- [ ] **Delete metrics section from Ch 2, keep only what Ch 3.6 needs**
  Task ID: p1-02
...
- [ ] **Rewrite Ch 3.6 (Evaluation Metrics) with use-case justification per metric**
  Task ID: p1-03
...
- [ ] **Move Section 4.1 (Silver Answer Validity) to Discussion**
  Task ID: p1-04
...
- [ ] **Move Section 5.5 (Metric Correlation Analysis) to Results**
  Task ID: p1-05
...
- [ ] ~~**Move Logprobs fallback discussion to Discussion or shorten**~~ *(superseded by p3-10: G-Eval to Appendix)*
  Task ID: p1-06
...
- [ ] **Ch 2.2: Remove Privacy/Security if unused in methodology**
  Task ID: p2-01
...
- [ ] **Ch 2.2: Add relevance bridge for Specialized Medical Applications**
  Task ID: p2-02
...
- [ ] **Ch 2.3: Move "Implications" to the BEGINNING of the section**
  Task ID: p2-03
...
- [ ] **Ch 2.3: Cut "Historical Context" subsection**
  Task ID: p2-04
...
- [ ] **Ch 2.3: Add source for SLM definition (<100B parameters)**
  Task ID: p2-05
...
- [ ] **Ch 2.4: Add citations to "Why Prompt Engineering Matters" (5 claims)**
  Task ID: p2-06
...
- [ ] **Ch 2.4: Remove duplicate prompting techniques table (already in Appendix)**
  Task ID: p2-07
...
- [ ] **Ch 2.4: Qualify "optimal technique" claim for CoT**
  Task ID: p2-08
...
- [ ] **Describe the evaluation pipeline as a coherent system**
  Task ID: p3-01
...
- [ ] **Explain procedure phases narratively (not just list)**
  Task ID: p3-02
...
- [ ] **Declare source of methodology overview figure**
  Task ID: p3-03
...
- [ ] **Add GraSCCo example or cross-reference to Appendix**
  Task ID: p3-04
...
- [ ] **Define Golden Answer vs Silver Answer clearly at first use**
  Task ID: p3-05
...
- [ ] **Justify English prompts for German documents**
  Task ID: p3-06
...
- [ ] **Derive JSON Structural Similarity: why, what, significance**
  Task ID: p3-07
...
- [ ] **Derive DAG metric: why, what, significance**
  Task ID: p3-08
...
- [ ] **Introduce llm-validator at first conceptual mention**
  Task ID: p3-09
...
- [ ] **Move G-Eval content to Appendix, note it was not used**
  Task ID: p3-10
...
- [ ] **Clean up "Model Output Filtering" draft marker**
  Task ID: p3-11
...
- [ ] **Remove EULA boilerplate from Ch 3.4**
  Task ID: p3-12
...
- [ ] **Decision: "A Note on the Craft" — keep, footnote, or remove?**
  Task ID: p4-01
...
- [ ] **Tighten motivation — keep it concise**
  Task ID: p4-02
...
- [ ] **Add transition from Research Questions to Ch 2**
  Task ID: p4-03
...
- [ ] **Reduce repetitive model listing in Ch 4.2**
  Task ID: p5-01
...
- [ ] **Add metric interpretation per results table**
  Task ID: p5-02
...
- [ ] **Add explicit table references in Discussion interpretations**
  Task ID: p5-03
...
- [ ] **Define or justify 95% pass-rate threshold in RQ1 answer**
  Task ID: p5-04
...
- [ ] **Add variability data for Limitation 3 (single evaluation run)**
  Task ID: p5-05
...
- [ ] **Resolve stale comment references (#R-TAB-SEMANTIC, #R-TAB-PASS)**
  Task ID: p5-06
...
- [ ] **Build PDF and fix all "??" broken references**
  Task ID: p6-01
...
- [ ] **Check BFH template compliance (logo, headers, footers)**
  Task ID: p6-03
...
- [ ] **Insert GitLab repository link (not in Abstract)**
  Task ID: p6-04
...
- [ ] **Declare all AI-generated figures**
  Task ID: p6-05
...
- [ ] **Full PDF build — verify page count decreased**
  Task ID: p7-01
...
- [ ] **Read-through: verify "roter Faden" (narrative flow)**
  Task ID: p7-02
