...
% Image scaling for Pandoc 3.2+
\makeatletter
\def\maxwidth{\ifdim\Gin@nat@width>\linewidth\linewidth\else\Gin@nat@width\fi}
\def\maxheight{\ifdim\Gin@nat@height>\textheight\textheight\else\Gin@nat@height\fi}
\makeatother
\setkeys{Gin}{width=\maxwidth,height=\maxheight,keepaspectratio}
% Required by Pandoc 3.2+ for bounded images
...
% Reduce font size for all longtables (Pandoc tables) to prevent column overflow
\usepackage{etoolbox}
...
% Inline citation support (link-citations: true)
...
% Float control — force figures to appear at their source position
\usepackage{float}
...
\newcommand{\maketitlepage}{
  \begin{titlepage}
    ...
    \begin{tabular}{@{}p{4cm}p{8cm}@{}}
      ...
      $endif$
      $if(version)$
      Version: & \href{https://github.com/kindofwhat/dsp4d/commit/$version$}{\texttt{$version$}} \\[0.3em]
      $endif$
    \end{tabular}
    \end{center}
