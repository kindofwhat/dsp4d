...
Silver answers have values when used in a relative manner, i.e. when comparing different smaller models. Also consider that expert answers may also differ significantly in the context of field of expertise, especially in a medical domain.
